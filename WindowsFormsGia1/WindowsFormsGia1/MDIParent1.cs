...
namespace WindowsFormsGia1
{
    public partial class MDIParent1 : Form
    {
        ...
        {
            Suma ejercicio4 = new Suma();
            ejercicio4.MdiParent = this;
            ejercicio4.Show();
        }

        private void ejercicio5ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Usodll ejercicio5 = new Usodll();
            ejercicio5.MdiParent = this;
            ejercicio5.Show();
        }
    }
}
